...
<form:form  action="/EmployeeSpringMVc/viewEmployee" commandName="employee" method="POST">
		...
		<fieldset class="boxBody">
			...
			<input type="submit" formaction="/EmployeeSpringMVc/viewEmployee" class="btnCreate" name="submit" id="submit" tabindex="2"
				value="View"> 
