package IMCS.trng.April2017.EmployeeAppSpringCore.EmployeeRepositoryImplementation;
...
@Repository("EmployeeCollectionRepository")
public class EmployeeDBRepository implements EmployeeRepositoryInterface {
    ...
    @Autowired
    public EmployeeDBRepository(EmployeeDaoInterface employeeDaoImplementation) {
